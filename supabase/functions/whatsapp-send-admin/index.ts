...
// Inline token-utils to avoid shared module import issues
...
async function generateMagicLinkToken(): Promise<{ token: string; tokenHash: string }> {
...
Please confirm your booking by replying "Confirm".`;
      ...
      // Generate magic link for customer account with hashed token for security
