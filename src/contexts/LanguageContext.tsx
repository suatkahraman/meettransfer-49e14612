...
const translations: Record<Language, Record<string, string>> = {
  ...
  JA: {
    ...
    heroSubtitle: "✈️ 往復送迎 – 30%オフ！到着と出発の空港送迎を一緒に予約すると30%割引 🎁 復路プロモコード: Meet40Return",
    ...
    servicesIntro: "ミートトランスファーは、トルコの人気観光地への高級空港送迎、プライベートシャトルサービス、VIPミニバン輸送を提供しています。車両にはメルセデス・ヴィト、メルセデス・Vクラス、VIPミニバス、マイバッハオプションがあります。",
    ...
    fleetIntro: "厳選されたメルセデス車両フリートで、最高の快適さとスタイルでご移動いただけます。すべての車両は最高水準で定期的に整備・清掃されています。",
    needHelp: "お困りですか？",
    ...
    aboutIntro1: "ミートトランスファーは、トルコの人気観光地への高級輸送を提供する、トルコをリードするプレミアム空港送迎サービスです。",
    aboutIntro2: "卓越性へのコミットメントは、完璧に整備されたメルセデスフリートから、厳格なトレーニングを受けたプロの英語を話すドライバーまで、サービスのあらゆる面に反映されています。",
    ...
    seoHomeDesc: "トルコでの高級VIP空港送迎とプライベートシャトルサービス。プロのドライバー、メルセデスフリート、24時間サービス。",
    loading: "読み込み中...",
