        ...
        {navItems.map((item) => {
          ...
          return (
            <motion.button
              ...
              className={cn(
                "flex flex-col items-center justify-center flex-1 h-full gap-1 relative touch-manipulation select-none py-2",
                active 
                  ? "text-primary" 
                ...
                <AnimatePresence>
                  {item.badge && item.badge > 0 && (
                    ...
                    >
                      <Badge 
                        variant="destructive" 
                        className="absolute -top-2 -right-2.5 h-4.5 min-w-4.5 px-1 flex items-center justify-center text-[10px] font-bold"
                      >
