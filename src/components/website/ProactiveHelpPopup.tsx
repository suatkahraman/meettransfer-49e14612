...
import { MessageCircle, X, Sparkles, Clock, Gift } from "lucide-react";
...
const ProactiveHelpPopup = memo(({ 
  ...
  return (
    <div
      className={`fixed bottom-24 right-4 md:bottom-8 md:right-8 z-50 max-w-sm transition-all duration-300 ease-out ${
        isAnimatingOut 
