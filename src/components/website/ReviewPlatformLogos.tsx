...
const platforms = [
  ...
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 24 24" className="w-5 h-5">
        <path fill="#EA4335" d="M3.18 3.12l8.91 8.88-8.91 8.88c-.37-.37-.6-.88-.6-1.47V4.59c0-.59.23-1.1.6-1.47z"/>
        <path fill="#FBBC04" d="M16.85 7.57l-4.76 4.43 4.76 4.43 3.62-2.12c.82-.48.82-1.66 0-2.14l-3.62-2.6z"/>
        <path fill="#4285F4" d="M3.18 3.12L12.09 12l-8.91 8.88"/>
        <path fill="#34A853" d="M3.18 20.88l9.91-9.88L16.85 14l-8.91 8.88c-.37.37-.88.6-1.47.6-.59 0-1.1-.23-1.29-.6z"/>
      </svg>
    ),
    rating: "4.7",
    reviews: "3,400+",
  ...
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 24 24" className="w-5 h-5">
        ...
        <path fill="#fff" d="M12 4l2.35 7.24H22l-6.18 4.49 2.36 7.27L12 18.51 5.82 23l2.36-7.27L2 11.24h7.65z"/>
