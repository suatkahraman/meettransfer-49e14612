...
export const Hero = () => {
  ...
  return (
    <section ref={heroRef} id="booking-form" className="relative overflow-hidden bg-background">
      ...
      {/* Added pb-20 on mobile to prevent bottom nav overlap */}
      <div className="container relative z-10 px-2 sm:px-3 md:px-4 pt-4 sm:pt-6 md:pt-8 pb-20 sm:pb-4 md:pb-8 lg:pb-16">
        <div className="grid md:grid-cols-5 lg:grid-cols-2 gap-3 sm:gap-4 md:gap-6 lg:gap-12 items-start lg:items-center min-h-[calc(100svh-8rem)] sm:min-h-[calc(100svh-5.5rem)] md:min-h-[calc(100svh-6rem)]">
          {/* Left Side - Form */}
