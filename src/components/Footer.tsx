        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-primary-foreground/80 text-sm">
              ...
              <li><PrefetchLink to={getLocalizedPath("/switzerland-transfer")} className="hover:text-primary-foreground transition-colors">{t('footerSwitzerland')}</PrefetchLink></li>
