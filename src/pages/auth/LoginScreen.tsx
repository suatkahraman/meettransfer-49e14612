...
const LoginScreen = () => {
  ...
  let iframeSrc = "https://meettransfer.com/login";
  if (roleParam === 'driver') iframeSrc = "https://meettransfer.com/login/driver";
  if (roleParam === 'agency') iframeSrc = "https://meettransfer.com/login/agency";
