...
const FleetPage = () => {
  ...
  const vehicles = [
    ...
    },
    {
      ...
      images: [maybach1, meetTransferDubai, maybach2, maybachInterior, maybachPassengersBlue, maybach3, meetTransferCyprus, maybachInteriorPurple, maybach4, maybach5, maybachInteriorOrange, maybach6],
    },
    {
      name: t("sprinterName"),
