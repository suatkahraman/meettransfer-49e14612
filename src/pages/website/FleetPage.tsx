  ...
  const vehicles = [
    ...
    },
    {
      ...
      images: [
        ...
        { src: vito6, alt: "Mercedes Vito premium airport transfer vehicle" },
      ],
    },
    {
      name: t("maybachName"),
      ...
      images: [
        ...
        { src: maybach6, alt: "Mercedes Maybach Minivan luxury chauffeur service" },
      ],
    },
    {
      name: t("sprinterName"),
      ...
      images: [
        ...
        { src: sprinter6, alt: "Mercedes Sprinter VIP minibus luxury transport" },
      ],
    },
  ];
