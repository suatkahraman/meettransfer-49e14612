...
import { ChevronRight, Shield, Clock, MapPin, Users, Star, CheckCircle, Route, Car, Navigation, Mountain, Building, ArrowLeft } from "lucide-react";
          ...
          <div className="relative rounded-xl overflow-hidden mb-8">
            ...
            <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-white font-medium">4.7 Rating • 50,000+ Transfers</span>
              </div>
            </div>
          </div>
        </div>
