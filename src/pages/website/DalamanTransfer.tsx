...
const prices = [
  { from: "DLM Airport", to: "Göcek", price: "Request Price" },
  { from: "DLM Airport", to: "Fethiye", price: "Request Price" },
  { from: "DLM Airport", to: "Ölüdeniz", price: "Request Price" },
  { from: "DLM Airport", to: "Marmaris", price: "Request Price" },
  { from: "DLM Airport", to: "İçmeler", price: "Request Price" },
  { from: "DLM Airport", to: "Kaş", price: "Request Price" },
  { from: "DLM Airport", to: "Kalkan", price: "Request Price" },
];
    ...
    <WebsiteLayout>
      ...
      <SchemaOrg
        schemas={[
          ...
          { type: 'TransportationService', areaServed: ['Dalaman', 'Dalaman Airport', 'DLM'] },
        ]}
      />
