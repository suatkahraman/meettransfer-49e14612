...
const prices = [
  { from: "AYT Airport", to: "Lara", price: "€25" },
  { from: "AYT Airport", to: "Belek", price: "€35" },
  { from: "AYT Airport", to: "Side", price: "€50" },
  { from: "AYT Airport", to: "Alanya", price: "€70" },
  { from: "AYT Airport", to: "Kemer", price: "€45" },
];
