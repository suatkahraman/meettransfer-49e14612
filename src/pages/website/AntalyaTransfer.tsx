...
const vehicles = [
  {
    ...
    images: [
      { src: vipVitoStarlightLuxury, alt: "Mercedes VIP Vito couple champagne starlight ceiling luxury transfer" },
      { src: vitoVipStarlightPurple, alt: "Mercedes VIP Vito purple starlight roof interior Antalya" },
    ],
  },
  {
    name: "Mercedes Vito",
    ...
    images: [
      { src: vitoAirportPremium, alt: "Mercedes Vito VIP airport transfer Antalya with chauffeur" },
      { src: vitoLuxuryInterior, alt: "Mercedes Vito luxury interior passengers Antalya transfer" },
    ],
  },
];
    ...
    <WebsiteLayout>
      ...
      <SchemaOrg
        schemas={[
          ...
          { type: 'TransportationService', areaServed: ['Antalya', 'Antalya Airport', 'AYT'] },
        ]}
      />
