...
const CustomerProfile = () => {
  ...
  const translations = {
    ...
    IT: {
      ...
      emailChangeError: 'Impossibile cambiare email',
      ...
      emailPlaceholder: 'Inserisci il nuovo indirizzo email',
      notifications: 'Notifiche',
      notificationsDesc: 'Gestisci le tue preferenze di notifica',
      pushNotifications: 'Notifiche Push',
      pushEnabled: 'Attivato',
      pushDisabled: 'Disattivato',
      pushNotSupported: 'Non supportato su questo dispositivo',
      pushDenied: 'Permesso negato nelle impostazioni del browser',
      enablePush: 'Attiva',
      disablePush: 'Disattiva',
    },
    ES: {
      title: 'Mi Perfil',
      ...
      emailChangeSuccess: 'Email de verificación enviado a la nueva dirección',
      emailChangeError: 'Error al cambiar el email',
      noChanges: 'No hay cambios para guardar',
      namePlaceholder: 'Ingresa tu nombre completo',
      phonePlaceholder: 'Ingresa tu número de teléfono',
      emailPlaceholder: 'Ingresa tu nuevo correo electrónico',
      notifications: 'Notificaciones',
      notificationsDesc: 'Administra tus preferencias de notificación',
      pushNotifications: 'Notificaciones Push',
      pushEnabled: 'Activado',
      pushDisabled: 'Desactivado',
      pushNotSupported: 'No compatible con este dispositivo',
      pushDenied: 'Permiso denegado en la configuración del navegador',
      enablePush: 'Activar',
    ...
    UK: {
      ...
      emailChangeSuccess: 'Лист підтвердження надіслано на нову адресу',
      ...
      emailPlaceholder: 'Введіть нову адресу електронної пошти',
      notifications: 'Сповіщення',
      notificationsDesc: 'Керуйте налаштуваннями сповіщень',
      pushNotifications: 'Push-сповіщення',
      pushEnabled: 'Увімкнено',
      pushDisabled: 'Вимкнено',
      pushNotSupported: 'Не підтримується на цьому пристрої',
      pushDenied: 'Дозвіл відхилено в налаштуваннях браузера',
      enablePush: 'Увімкнути',
      disablePush: 'Вимкнути',
    },
    JA: {
      title: 'マイプロフィール',
      subtitle: '個人情報を更新してください',
      fullName: '氏名',
      phone: '電話番号',
      email: 'メールアドレス',
      currentEmail: '現在のメール',
      newEmail: '新しいメール',
      changeEmail: 'メールを変更',
      cancelEmailChange: 'キャンセル',
      save: '変更を保存',
      saving: '保存中...',
      back: '戻る',
      success: 'プロフィールが正常に更新されました',
      error: 'プロフィールの更新に失敗しました',
      emailChangeSuccess: '確認メールが新しいアドレスに送信されました',
      emailChangeError: 'メールの変更に失敗しました',
      noChanges: '保存する変更がありません',
      namePlaceholder: '氏名を入力してください',
      phonePlaceholder: '電話番号を入力してください',
      emailPlaceholder: '新しいメールアドレスを入力してください',
      notifications: '通知',
      notificationsDesc: '通知設定を管理',
      pushNotifications: 'プッシュ通知',
      pushEnabled: '有効',
      pushDisabled: '無効',
      pushNotSupported: 'このデバイスではサポートされていません',
      pushDenied: 'ブラウザ設定で許可が拒否されました',
      enablePush: '有効にする',
      disablePush: '無効にする',
    },
  };
