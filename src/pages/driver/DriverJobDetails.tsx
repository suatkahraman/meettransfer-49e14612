...
const DriverJobDetails = () => {
  ...
  const getReservationDetailsText = () => {
    ...
    const lines = [
      ...
      ``,
      reservation.passenger_cash_amount ? `💵 *Tahsil Edilecek:* ${reservation.passenger_cash_amount} ${reservation.passenger_cash_currency || 'TRY'}` : null,
      reservation.driver_cash_amount ? `✅ *Tahsil Edilen:* ${reservation.driver_cash_amount} TRY` : null,
      ``,
